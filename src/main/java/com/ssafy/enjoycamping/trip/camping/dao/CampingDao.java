...
public interface CampingDao {
    Optional<CampingDto> selectById(int id);
    List<CampingDto> selectByCondition(String keyword, Integer sidoCode, Integer gugunCode, PagingAndSorting pagingAndSorting);
